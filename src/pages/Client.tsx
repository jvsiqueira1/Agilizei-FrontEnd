...
export default function ClientFinal() {
  ...
  return (
    <div className="min-h-screen bg-light-gray text-black">
      <Header />
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {(activeTab === 'ongoing' ? ongoingServices : completedServices).map(
            (service) => (
  ...
  const BudgetsModal = ({
    ...
    return (
      <div className="fixed inset-0 z-50 overflow-auto bg-black bg-opacity-50 flex justify-center items-center p-4">
        <div className="bg-light-gray p-6 rounded-lg w-full max-w-md max-h-[calc(100vh-4rem)] overflow-y-auto relative">
